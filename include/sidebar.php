    ...
    <div class="card p-3">
        <div class="card-body">
            <h3> درباره ما </h2>
                ...
                زیست‌بوم یا زیمانبه مناطق زندگی تمام گیاهان، جانوران و سایر موجودات با شرایط طبیعی محیط در یک منطقه ویژه گفته می‌شود. یک زیمان با انواع حیات جانوری مشخص با توجه به موقعیت، شرایط آب وهوایی، عرض جغرافیایی و ارتفاع تعیین می‌شود.
ما در زیست بوم با زیست‌بوم‌های اصلی کره زمین اشنا می شیم و اطلاعاتمون را با هم به اشتراک می گذاریم.        </div>
    </div>
